...
public class User implements Serializable {
    ...
    /**
     * @return the user_status_id
     */
    public User_Status getUser_status_id() {
        return user_status_id;
    }

    /**
     * @param user_status_id the user_status_id to set
     */
    public void setUser_status_id(User_Status user_status_id) {
